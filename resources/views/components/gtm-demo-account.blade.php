<div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto p-6">
    ...
    {{-- <!-- Live Account Card -->
    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow p-6 cursor-pointer account-card" data-type="live">
        <h3 class="text-xl font-bold text-gray-800 mb-4">Live Account</h3>
    ...
    document.querySelectorAll('.create-account-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            const formData = {
                ...
                account_type: type === 'demo' ? 'demo' : 'live',
